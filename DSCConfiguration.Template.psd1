...
RootModule = '.\DSCConfiguration.Template.psm1'
...
RequiredModules = @(@{ModuleName = "xPSDesiredStateConfiguration"; ModuleVersion = "5.0.0.0"},'xPendingReboot')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        WindowsOSVersion = '2008-R2-SP1','2012-Datacenter','2012-R2-Datacenter','2016-Datacenter','2016-Nano-Server'
